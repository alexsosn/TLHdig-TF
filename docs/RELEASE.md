...
manuscript-apparatus conservation, sign-language conservation, Contract A, marker, tag, provenance, alignment,
...
requires the exact `release-v4` gate profile, required input identities, artifact-digest
...
`release-v4` repeats this protection as the final required gate, after all external
