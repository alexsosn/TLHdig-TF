...
**Current TF version: `0.2.1` — integration prototype. Do not use it as the sole basis for
research conclusions yet.**

The generated dataset is committed in [`tf/0.2.1/`](tf/0.2.1), the Text-Fabric app
...
upstream TLHdig release, while `tfVersion = 0.2.1` identifies this conversion model and
build.
