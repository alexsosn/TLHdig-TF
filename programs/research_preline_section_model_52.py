...
def main() -> int:
    ...
    problems = []
    if pre_sec != ("D",):
        problems.append(f"pre-line section unexpectedly {pre_sec!r}, expected document-only ('D',)")
    if body_sec != ("D", "I", "1"):
    ...
    if problems:
        ...
        for problem in problems:
            print("-", problem)
        return 1
    print("PASS: Text-Fabric preserves a document-only slot without inventing column/line navigation")
    return 0
