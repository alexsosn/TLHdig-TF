...
DESCRIPTIONS = {
    ...
    "cu_aligned": "how this line's cuneiform was laid out per sign: 0 not aligned, 1 counts matched and were zipped, 2 aligned after absorbing surplus U+2592 placeholders into a recorded lacuna, 3 aligned after expanding a compound logogram, 4 aligned using the derived numeral rule. Higher numbers are weaker evidence, so a query wanting only the safest material filters cu_aligned=1. Measured against the learned reading->sign table, level 1 assignments contradict it in 0.2% of cases and level 2 in 1.0%; see reports/alignment.md.",
