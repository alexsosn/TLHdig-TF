...
@description=unresolved manuscript reference/context preserved when the source statement has no recoverable fragment endpoint; never an inferred endpoint
@language=hit
@license=CC-BY-4.0
@name=TLHdig
